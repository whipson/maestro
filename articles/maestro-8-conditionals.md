...
```
    ...
    [random_execution] [INFO] [2026-04-15 18:18:52]: Maybe, maybe not               
    ✔ random_execution [45ms]                                                       
                                                                                    
    ── [2026-04-15 18:18:52]                                                        
    Pipeline execution completed ■ | 0.104 sec elapsed                              
...
```
    ...
    ── [2026-04-15 18:18:53]                                                        
    Pipeline execution completed ■ | 0.092 sec elapsed                              
    ✔ 2 successes | ! 0 warnings | ✖ 0 errors | ◼ 2 total                           
    ────────────────────────────────────────────────────────────────────────────────
                                                                                    
    ── Next scheduled pipelines ❯                                                   
    Pipe name | Next scheduled run                                                  
    • extract_flights | 2026-04-15 19:00:00                                         
...
```
    ...
    [process_payments] [INFO] [2026-04-15 18:18:53]: Payments processed             
