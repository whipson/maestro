...
- Pipeline errors, warnings, and messages can now be printed to the console using `run_schedule(console_out = TRUE)`. These logs will be interwoven between messages created by `maestro` (#130).
