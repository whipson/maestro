...
vignette: >
  %\VignetteIndexEntry{maestro-motivation-concepts}
...
Pipeline configuration is covered in more detail here [linking vignette].
...
By passing the `orch_frequency = "hour"` and `orch_interval = 1` to `run_schedule()`, we're saying that we intend to run the orchestrator every 1 hour.
